...
@REM set JDK_PATH="C:\Program Files\Java\jdk1.7.0_45\bin"
...
@REM %JDK_PATH%\jar.exe -cvfm splunk-modularinputs-influxdb.jar MANIFEST.MF org.influxdb/*.class -C bin/ . && 
%JDK_PATH%\java.exe -jar splunk-modularinputs-influxdb.jar --scheme && copy splunk-modularinputs-influxdb.jar "%SPLUNK_APP_PATH%\jars" /Y
...
set CMD=xcopy lib "%SPLUNK_APP_PATH%\lib" /Y /E
echo %CMD%
%CMD%

set CMD=xcopy local "%SPLUNK_APP_PATH%\local" /Y /E
echo %CMD%
%CMD%